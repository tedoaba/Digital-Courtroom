...
def analyze_graph_consistency() -> dict:
    ...
    violations = []
    if "repo_investigator" not in nodes_found:
        violations.append("Missing repo_investigator node")
    if "chief_justice" not in nodes_found:
        violations.append("Missing chief_justice node")
