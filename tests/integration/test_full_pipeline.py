...
from src.nodes.justice import chief_justice_node, report_generator, sanitize_repo_name
...
def test_judicial_note_rendering(complex_agent_state):
    ...
    complex_agent_state["opinions"][0] = complex_agent_state["opinions"][0].model_copy(update={"score": 4})
