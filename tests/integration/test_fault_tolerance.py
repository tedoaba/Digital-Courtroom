...
def test_detective_failure_partial_report(mock_initial_state, mocker):
    """
    ...
    repo_mock = mocker.patch("src.nodes.detectives.repo_investigator", side_effect=Exception("Simulated RepoInvestigator Failure"))
    ...
    assert final_state["metadata"]["run_status"] == "FAILED"
    
    # Verify report was generated
    repo_name = sanitize_repo_name("fault-repo")
...
def test_empty_repository_handling(mock_initial_state, mocker):
    """
    ...
    repo_mock = mocker.patch("src.nodes.detectives.repo_investigator", return_value={"evidences": {"repo": []}})
    repo_mock.__name__ = "repo_investigator"
