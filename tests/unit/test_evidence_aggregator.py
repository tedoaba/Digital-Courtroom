...
def create_mock_evidence(id: str, source: str = "repo", location: str = "file.py") -> Evidence:
    return Evidence(
        evidence_id=id,
        source=source,
    ...
    state = {
        "evidences": {
            ...
            "docs": [
                ...
                create_mock_evidence("docs_1", source="docs", location="src/existing.py"),
                create_mock_evidence("docs_2", source="docs", location="src/hallucination.py")
            ]
        },
        "errors": []
    }
...
def test_integration_simulated_graph_flow():
    ...
    state = {
        "evidences": {
            ...
            "vision": [create_mock_evidence("v1", source="vision", location="image.png")]
        },
        "errors": []
    }
