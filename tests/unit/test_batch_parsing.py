...
from src.nodes.judges import JudicialOpinion
...
class TestBatchParsingLogic:
    ...
    def test_corrupt_entries_discarded(self):
        ...
        batch = [
            {"criterion_id": "DIM1", "score": 4, "judge": "Prosecutor", "opinion_id": "1", "argument": "A", "cited_evidence": []},
            {"criterion_id": "DIM2", "score": "invalid", "judge": "Prosecutor"}, # Corrupt score
